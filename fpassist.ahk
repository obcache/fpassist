...
flashRetrieve(*) {
	(tmp.retrieveFlashOn := !tmp.retrieveFlashOn)
		...
		: (ui.retrieveButtonBg.opt("background" ui.trimDarkColor[3]),ui.retrieveButton.opt("1f1105"),ui.retrieveButtonHotkey.opt("1f1105"),ui.retrieveButtonBg.redraw(),ui.retrieveButton.redraw())
}
