...
initApp(*) {
	...
	if a_isCompiled && !fileExist(cfg.file) {
...
initGui(*) {
	...
	createGui(*) {
		...
		ui.titleBarText := ui.fishGui.addText("x305 y5 w1280 h30 cC7C7C7 backgroundTrans","Fishing Planet`t(fpassist v" ui.appVersion ")")
