...
createGuiFS(*) {
	...
	ui.profileNextFS := ui.fishGuiFS.addPicture("x" ui.fsIcons.x[a_screenwidth]+134 " y" ui.fsIcons.y[a_screenwidth]+6 " w20 h26 background" ui.bgColor[3],"./img/button_arrowRight_knot.png")
	ui.profileSelectedBg := ui.fishGuiFS.addText("center x" ui.fsIcons.x[a_screenwidth]+160 " y" ui.fsIcons.y[a_screenwidth]+5 " w340 h28 center background" ui.bgColor[3] " c" ui.trimFontColor[6])
	ui.profileSelectedFS := ui.fishGuiFS.addText("center x" ui.fsIcons.x[a_screenwidth]+158 " y" ui.fsIcons.y[a_screenwidth]+3 " w340 h28 center backgroundTrans c" ui.trimFontColor[6],cfg.profileName[cfg.profileSelected])
	ui.helpButton := ui.fishGuiFS.addText("x" ui.fsIcons.x[a_screenwidth]+496 " y" ui.fsIcons.y[a_screenwidth]+4 " w24 h24 backgroundTrans c" ui.fontColor[1],"s")
	ui.helpButton.setFont("s19 c" ui.trimFontColor[6],"Webdings")
	ui.helpButton.onEvent("click",toggleHelp)
	ui.profileEdit := ui.fishGuiFS.addPicture("x" ui.fsIcons.x[a_screenwidth]+64 " y" ui.fsIcons.y[a_screenwidth]+9 " w20 h20 backgroundTrans","./img/button_settings.png")
	...
	ui.fs_profileDeleteButton := ui.fishGuiFS.addPicture("x" ui.fsIcons.x[a_screenwidth]+169+ui.fsIcons.xOffset[a_screenWidth]+ui.fsIcons.w[a_screenwidth]-148 " y" ui.fsIcons.y[a_screenwidth]+9 " w20 h20 backgroundTrans","./img/button_delete.png")
	...
	ui.fs_profileEditButton := ui.fishGuiFS.addPicture("x" ui.fsIcons.x[a_screenwidth]+166+ui.fsIcons.xOffset[a_screenwidth]+ui.fsIcons.w[a_screenwidth]-170 " y" ui.fsIcons.y[a_screenwidth]+7 " w24 h24 backgroundTrans","./img/button_edit.png")
